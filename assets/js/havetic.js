(function ($) {
  ...
  let thmOwlCarousels = $(".havetic-owl__carousel");
  ...
  function thmTinyInit() {
    // tiny slider
    const tinyElm = document.querySelectorAll(".havetic-tiny__slider");
  ...
  function havetic_stretch() {
    var i = $(window).width();
    $(".row .havetic-stretch-element-inside-column").each(function () {
      var $this = $(this),
